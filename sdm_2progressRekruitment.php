...
<tr><td colspan="2">
        <button onclick="zPreview('sdm_slave_2progressRekruitment','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
        <!--<button onclick="zPdf('sdm_slave_2progressRekruitment','<?php echo $arr?>','printContainer')" class="mybutton">PDF</button>-->
        <button onclick="zExcel(event,'sdm_slave_2progressRekruitment.php','<?php echo $arr?>')" class="mybutton">Excel</button>
       </td></tr>

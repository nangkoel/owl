  ...
  while($bar=mysql_fetch_object($res))
  {
   ...
   while($bar1=mysql_fetch_object($res1))
   {
	...
	echo"<tr class=rowcontent>
	  ...
	  </tr>";// <td align=right><input type=text class=myinputtextnumber size=14 onkeypress=\"return angka_doang(event);\" value=".($bar->notransaksi!=0?$bar->byticket:0)." id=t".$bar->notransaksi."></td>

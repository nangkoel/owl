...
//==================================================================================================================================================================
 echo"<div>
	 ...
	 <legend>[Info] Menu Level:</legend>
	 This uses the levelization access to menu item. 
	 Each user can access all the menu items that have a 
	 level less than or equal to user's access level.<br>
	 <b>0</b> mean <b>anonymous</b>(every user can access).
	 </fieldset><br>
...
<input type=button value=Close class=mybutton onclick=\"hideDetailForm('ctr','ctrmenu');hideThis('lab0');\">
<br><br>";
?>

...
//query baru untuk mencegah kesalahan golongan, golongan di ganti menjadi makeOption.
//ind 6-02-14
...
$str="select a.*,b.namajabatan,d.tipe from ".$dbname.".datakaryawan a, 
	  ...
	  OR lokasitugas='') order by a.nik asc limit ".$maxdisplay.",".$getrows
	  ;  
}
else
{

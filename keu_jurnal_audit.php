...
#== Prep List Header
$header = array($_SESSION['lang']['kodeabs'],$_SESSION['lang']['nomor'],$_SESSION['lang']['tanggal'],$_SESSION['lang']['noreferensi'],$_SESSION['lang']['matauang'],$_SESSION['lang']['debet'],$_SESSION['lang']['kredit'],$_SESSION['lang']['revisi']);
...
$els[] = array(
    ...
    makeElement('tanggal','text','31-12-'.(date('Y')-1),array('style'=>'width:80px','readonly'=>'readonly',
...
$els[] = array(
    ...
    makeElement('noreferensi','text','',array('style'=>'width:80px','maxlength'=>'20',
        'onkeypress'=>'return tanpa_kutip(event)','disabled'=>'disabled','onkeyup'=>'var tmp = this.value;this.value = tmp.toUpperCase()'))
);
$els[] = array(
    makeElement('matauang','label',$_SESSION['lang']['matauang']),
    makeElement('matauang','select','IDR',array('style'=>'width:70px',

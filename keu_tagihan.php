...
$ctl[] = "<fieldset><legend><b>".$_SESSION['lang']['find']."</b></legend>".
    ...
    makeElement('sNoTransSupp','label',$_SESSION['lang']['noinvoice']." Supplier").
    makeElement('sNoTransSupp','text','',array('onkeypress'=>"return validat(event)")).'&nbsp;'.
    makeElement('sNoPo','label',$_SESSION['lang']['nopo']).
    makeElement('sNoPo','text','',array('onkeypress'=>"return validat(event)")).

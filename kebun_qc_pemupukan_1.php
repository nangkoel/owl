...
OPEN_BOX();
$frm[0].="<fieldset style=\"width:800px;\">";
		...
		$frm[0].="<table border=0 cellpadding=1 cellspacing=1>";
			$frm[0].="
                            ...
                            <tr>
                                ...
                                <td><select id=kodeafdeling name=kodeafdeling style=width:150px onchange=getBlok()>".$optAfd."</select></td>
                                <td>".$_SESSION['lang']['dosis']."</td><td>:</td>
                                <td colspan=5><input type=text id=dosis name=dosis value='0' onkeypress=\"return angka_doang(event);\" value='' class=myinputtextnumber style=\"width:150px;\"></td>
                            </tr>
                            <tr>
                                <td>".$_SESSION['lang']['blok']."</td><td>:</td>
                                <td><select id=kodeblok name=kodeblok style=width:150px>".$optBlok."</select></td>
                            ...
                            <tr>
                                <td>".$_SESSION['lang']['nama']." ".$_SESSION['lang']['pengawas']."</td><td>:</td>
                                <td><select id=namapengawas name=namapengawas style=width:150px>".$optKar."</select></td>
                            ...
                            <tr>
                                <td>".$_SESSION['lang']['pengawas']."</td><td>:</td>
                                <td><select id=pengawas name=pengawas style=width:150px>".$optKar."</select></td>
                            </tr>
                            <tr>
                                <td>".$_SESSION['lang']['asisten']."</td><td>:</td>
                                <td><select id=asisten name=asisten style=width:150px>".$optKar."</select></td>
                            </tr>
                            <tr>
                                <td>".$_SESSION['lang']['mengetahui']."</td><td>:</td>
                                <td><select id=mengetahui name=mengetahui style=width:150px>".$optKar."</select></td>
                            </tr>
                            <tr>
				<td>
...
$frm[0].="  <tr>
                <td>".$_SESSION['lang']['nourut']." ".$_SESSION['lang']['jalur']."</td> 
                <td>:</td>

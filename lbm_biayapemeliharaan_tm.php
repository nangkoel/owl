...
$arr="##unit##periode##judul##afdId##tipe"; 
...
$sOrg="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi where CHAR_LENGTH(kodeorganisasi)='4' and namaorganisasi not like 'PLASMA%' and tipe='KEBUN' order by namaorganisasi asc";
...
$optTipe.="<option value='I'>Inti</option>";
$optTipe.="<option value='P'>Plasma</option>";
...
<table cellspacing=\"1\" border=\"0\" >
    ...
    <tr><td><label>".$_SESSION['lang']['tipe']."</label></td><td><select id='tipe' style=\"width:200px;\" onchange=getKbn(this)>".$optTipe."</select></td></tr>    

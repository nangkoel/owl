...
$aresta="SELECT noakun,sum(jumlah) as biaya FROM ".$dbname.".keu_jurnaldt_vw
    WHERE kodeorg like '".$unit."%' and tanggal like '".$periode."%' and (noakun like '7%' or noakun like '8%')
         && (noakun not in ('8110101','8110102','8110103','8110104'))
    GROUP BY noakun";
//echo $aresta;
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
...
$aresta="SELECT noakun,sum(rp".$bulan.") as budget FROM ".$dbname.".bgt_budget_detail
    ...
    (noakun like '7%' or noakun like '8%') && (noakun not in ('8110101','8110102','8110103','8110104'))
    GROUP BY noakun";
//echo $aresta;
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
...
$aresta="SELECT noakun,sum(jumlah) as biaya FROM ".$dbname.".keu_jurnaldt_vw
    ...
    && (noakun not in ('8110101','8110102','8110103','8110104')) GROUP BY noakun";
//echo $aresta;
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{

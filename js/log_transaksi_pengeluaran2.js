...
function getKary(title,pil,ev){
        ...
        if(utkUnit!=''){
         ...
         if(pil==2){
                content= "<div style='width:100%;'>";
                content+="<fieldset>"+title+"<input type=hidden id=unit value="+utkUnit+" /><input type=hidden id=subunit value="+sbUnit+" /><input type=text id=txtnamabarang class=myinputtext size=25 maxlength=35 onkeypress=\"return validatCari("+pil+",event);\"><button class=mybutton onclick=goCariKary("+pil+")>Go</button> </fieldset>";
                content+="<div id=containercari style='overflow:scroll;height:300px;width:520px'></div></div>";                 
         }
         if(pil==3){
                content= "<div style='width:100%;'>";

...
//   $ctrqty=$bar3[0];
  ...
  $this->SetFont('Helvetica','B',20);
   ...
   $this->Cell(40);
   //Judul dalam bingkai
   $this->Cell(250,10,'Realisasi SIPB',0,0,'C');
   //Ganti baris
   $this->Ln(10);
   ...
   $this->SetFont('Arial','B',10);
   $this->Cell(25,10,'Hal ',0,0,'L');
   $this->Cell(3,10,':',0,0,'L');
   $this->Cell(200,10,' Realisasi Pengiriman CRUDE PALM OIL / PALM KERNEL','',0,'L');
   $this->Ln(10);

   $this->SetFont('Arial','B',10);
   $this->Cell(200,10,'Dengan ini kami sampaikan Realisasi Pengiriman CRUDE PALM OIL sebagai berikut :','',0,'L');
   $this->Ln(10);
...
$query="select vehnocode,driver,ticketno, trpcode,spno, time(datein),time(dateout), wei1st,wei2nd,netto
        ...
        and sipbno=".$sipb." order by datein";
$hasil=mysql_query($query);
$result = array();
$i = 0;
$tot_jjg=0;

...
$cekPeriod="select distinct tanggalmulai,tanggalsampai from ".$dbname.".setup_periodeakuntansi where periode='".$periode."' and kodeorg like '".$traksiId."%'";
...
$str="SELECT a.nospb,sum(a.jjg) as jjg,b.tanggal,substr(a.nospb,9,6) as afdeling FROM ".$dbname.".kebun_spbdt a
           left join ".$dbname.".kebun_spbht b on a.nospb=b.nospb where b.tanggal between '".$rPeriod[0]['tanggalmulai']."' and '".$rPeriod[0]['tanggalsampai']."' 
           ".$whr." group by a.nospb order by tanggal,nospb";    
...
$sPabrik="select nospb,(jumlahtandan1+jumlahtandan2+jumlahtandan3) as jjgpabrik,beratbersih as berat,(beratbersih-kgpotsortasi) as beratbersih,
          ...
          and tanggal between '".$rPeriod[0]['tanggalmulai']."' and '".$rPeriod[0]['tanggalsampai']." 23:59:00' order by tanggal,nospb";
...
while($bar1=mysql_fetch_object($respabrik)){
    ...
    $nospb[$nospbx].=$bar1->nospb.' ';
    $tglpabrik[$nospbx].=$bar1->tanggal.' ';
    $tiket[$nospbx].=$bar1->notransaksi.' ';   
    $berat[$nospbx]+=$bar1->berat.' ';
    $beratbersih[$nospbx]+=$bar1->beratbersih.' ';  
    $jjgpabrik[$nospbx]+=$bar1->jjgpabrik.' ';    
    $nosppabrik[$nospbx].=$bar1->nospb.' ';   
}
...
<td align=center colspan=6>".$_SESSION['lang']['pabrik']."</td></tr>
            ...
            <td ".$bgcoloraja." align=right>".$_SESSION['lang']['jjg']."</td>
        ...
        if(!isset($nospbkebun[$spb])){
         ...
         if(!isset($nosppabrik[$spb])){
          ...
          $tab.="<tr class=rowcontent>
            ...
            <td bgcolor=".$colorkebun." nowrap>".tanggalnormal($tglkebun[$spb])."</td>
            <td bgcolor=".$colorkebun." align=right>".number_format($jjgkebun[$spb])."</td> 
            <td bgcolor=".$colorpabrik." nowrap>".tanggalnormal($tglpabrik[$spb])."</td>

...
function getNmLowongan()
{
	...
	tujuan='sdm_slave_medicalresult.php';
	function respog()
	{
		      if(con.readyState==4)
		      {
...
function saveView(){
    ...
    param='emailDt='+eml+'&proses=insrData'+'&hasilMedical='+hsl;
    param+='&cttnMedical='+cttn+'&tglMedical='+tglintr+'&idpermintaan='+idperm;
    param+='&tglMedical='+tglintr+'&nmprovider='+nmprovid;
        //alert(param);
    tujuan='sdm_slave_medicalresult.php';
    post_response_text(tujuan, param, respog);
    function respog()

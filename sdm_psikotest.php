...
<script type="text/javascript" src="js/sdm_psikotest.js"></script>
<script>
dataKdvhc="<?php echo $_SESSION['lang']['pilihdata']?>";
</script>
<?php
OPEN_BOX('',"<b>".$_SESSION['lang']['premitunasan']."</b>");
echo"<fieldset style=width:350px;><legend>".$_SESSION['lang']['form']." ".$_SESSION['lang']['psikotest']."</legend>";
##ambil departemen##

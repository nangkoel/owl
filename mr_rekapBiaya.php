...
echo open_body();
?>
<script language=javascript1.2 src='js/mr_rekapBiaya.js'></script>
<script language=javascript src='js/zReport.js'></script>
<?php

include('master_mainMenu.php');
OPEN_BOX('', '<b>' . strtoupper($_SESSION['lang']['managerialreport']) . ': ' . strtoupper($_SESSION['lang']['rekap'].' '.$_SESSION['lang']['biaya']) . '</b>');
...
$frm[0].="<fieldset><legend>".$_SESSION['lang']['rekap']." ".$_SESSION['lang']['biaya']."</legend>";
$frm[0].="<table cellspacing=1 border=0>
    <tr><td>".$_SESSION['lang']['perusahaan']."</td><td>:</td><td>
    <select id=pt name=pt style=width:220px; onchange=getkebun()>".$optpt."</select>
    </td></tr>
    <tr><td>Inti/Plasma</td><td>:</td><td>
    <select id=inti name=inti style=width:150px; onchange=getkebun()>
    ...
    <tr><td colspan=3>
        ...
        <button onclick=\"getexcel(event,'mr_slave_rekapBiaya.php')\" class=\"mybutton\" name=\"excel\" id=\"excel\">" . $_SESSION['lang']['excel'] . "</button>    
        <!--<button onclick=\"getpdf(event,'mr_slave_rekapBiaya.php')\" class=\"mybutton\" name=\"pdf\" id=\"pdf\">" . $_SESSION['lang']['pdf'] . "</button>-->
...
//========================
$hfrm[0] = $_SESSION['lang']['rekap']." ".$_SESSION['lang']['biaya'];

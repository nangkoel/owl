...
echo OPEN_BOX('','');
echo OPEN_THEME('Penerimaan Barang Per Tanggal');
echo OPEN_BOX();
$stg="select PRODUCTCODE,PRODUCTNAME from ".$dbname.".msproduct order by PRODUCTNAME";
//echo $stg;
$reg=mysql_query($stg);
...
echo"<table>
	   ...
	   <tr><td>Tanggal </td><td>:&nbsp;<input type=text id=tgllap tabindex='1' class=myinputtext size=10 onmousemove=setCalendar(this.id) onkeypress=\"return false;\"></td></tr>
		...
		<table align=center> 
		 <tr><td><input type=button id=button1 tabindex='2' class=tombol2 value=GO onclick=perTglAll();></td></tr>
		 </table>

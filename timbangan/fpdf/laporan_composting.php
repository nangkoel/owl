...
include('../laporan_composting.php');
require('fpdf2.php');
...
$tanggal=$_GET['tanggal'];
   $query="select PRODUCTNAME from wbridge.msproduct where PRODUCTCODE='".$product."' order by PRODUCTCODE";
  // echo $query;
  ...
  $this->SetFont('Helvetica','B',20);
   ...
   $this->Cell(40);
   //Judul dalam bingkai
   $this->Cell(250,10,'Laporan Pengeluaran Composting Per Product',0,0,'C');
   $this->Ln(10);
...
$query="select ticketno2,time(datein),time(dateout),vehnocode,driver,penerima,wei1st,wei2nd,netto
        from wbridge.mstrxtbs where date(dateout)='".$tgl2."' and productcode='".$product."' and OUTIN='0' order by dateout";
//echo $query;

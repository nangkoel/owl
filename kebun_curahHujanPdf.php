...
/** Report Prep **/
$cols = 'no,tanggal,pagi,mulai,selesai,sore,mulai,selesai,note';
$colArr = explode(',',$cols);
...
$length = explode(",","5,10,10,10,10,10,10,10,25");
		...
		//$no+=1;
			...
			for($a=1;$a<=$jmlhHari;$a++)
			{
					...
					$res=mysql_fetch_assoc($query);
						...
						$pdf->Cell(10/100*$width,$height,$tglProg,1,0,'L',1);
						$pdf->Cell(10/100*$width,$height,$res['pagi'],1,0,'R',1);
						$pdf->Cell(10/100*$width,$height,$res['mulaipagi'],1,0,'R',1);
						$pdf->Cell(10/100*$width,$height,$res['selesaipagi'],1,0,'R',1);
						$pdf->Cell(10/100*$width,$height,$res['sore'],1,0,'R',1);
						$pdf->Cell(10/100*$width,$height,$res['mulaisore'],1,0,'R',1);
						$pdf->Cell(10/100*$width,$height,$res['selesaisore'],1,0,'R',1);
						
						$pdf->Cell(25/100*$width,$height,$res['catatan'],1,1,'L',1);	
						
						//$length = explode(",","5,10,10,10,10,10,10,10,20");

...
//        echo 'error:'.$qwe;       
	...
	if($_SESSION['language']=='EN'){
		$optKeg = makeOption($dbname,'setup_kegiatan','kodekegiatan,namakegiatan1,satuan,noakun',$whereKeg,'2');
	}else{
	   $optKeg = makeOption($dbname,'setup_kegiatan','kodekegiatan,namakegiatan,satuan',$whereKeg,'2');
	}
	$optOrg = makeOption($dbname,'setup_blok','kodeorg,bloklama,kodeorg',$whereOrg,'8');
	...
	if(!empty($data)) {
		...
		$theForm2->_elements[2]->_attr['onchange'] = 'getHasilKerja()';
	...
	$optKary = makeOption($dbname,'datakaryawan','karyawanid,nik,namakaryawan',$whereKary,'5');
	...
	$theForm1->addEls('umr',$_SESSION['lang']['umrhari'],$Umr[0]['nilai']/25,'textnum','R',10);//6

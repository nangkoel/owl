...
var $UseHeader;          //flag set whether to use header or no
var $UseFooter;          //flag set whether to use footer or no
...
function FPDF($orientation='P', $unit='mm', $format='A4')
{
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008), 'a4narrow'=>array(595.28,841.89),);
	if(is_string($format))

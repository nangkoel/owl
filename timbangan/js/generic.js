...
function hubungkan_post(tujuan,param,funct)
{
 lock();
con.open("POST", tujuan, true);
con.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
//====================================================
function trim(stringToTrim){//trim space
...
function showDialog3(title,content,width,height,ev)
{
       if (document.getElementById('dynamic3')) {
		c.style.width = width+'px';
	   }
	   else {
	   	c = document.createElement('div');
	    ...
	    cont+="</div>";
            ...
            document.getElementById('dynamic3').style.top = '75px';
            document.getElementById('dynamic3').style.left = '200px';

...
//=================================================================
//
//To use this calendar just add "onmousemove=setCalendar(this.id)"
//to the element.
//Also you need the "calendarblue.css"
...
Calendar.setup = function (params) {
	...
	//param_default("ifFormat",       "%d-%m-%Y %H:%M");
	//param_default("daFormat",       "%d/%m/%Y %H:%M");
...
function setCalendar(objid,format)
{

...
//status bayar po
$arrDt=array(""=>"Seluruhnya","CASH"=>"CASH","CREDIT"=>"CREDIT");
foreach($arrDt as $dtlst=>$dtklrm)
{
    $optStatByr.="<option value='".$dtlst."'>".$dtklrm."</option>";
}

$arr="##periode##statId##ptId##statbayar";
...
$frm[0].="<div>
    ...
    <tr>
        <td><label>".$_SESSION['lang']['pembayaran']."</label></td>
        <td><select id=\"statbayar\" name=\"statbayar\" style=\"width:150px\">".$optStatByr."</select></td>
    </tr>

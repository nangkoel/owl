...
$stg="select * from ".$dbname.".msproduct order by PRODUCTCODE";
$reg=mysql_query($stg);
...
<strong><font size=3 color=#000000 font-family: Verdana, Arial, Helvetica, sans-serif>TIMBANG LAIN-LAIN</font>
</strong></td>
...
echo"<!--<fieldset style='width:100%;text-align:right;'>-->
	 ...
	 <b>Input Data Timbang Lain-Lain</b>
	 </legend>
     <table border=0>
					...
					<tr><td><b>NO. SP &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					:</b></td>
					<td><input type=text id=SPBNO tabindex='1' size=30 maxlength=35 onkeypress='return charAndNumAndStrip(event);' style='text-align:right;'>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<td><b>PENGIRIM &nbsp;&nbsp;:</b></td>
					...
					<td><b>PRODUCT &nbsp;&nbsp;:</b></td>
					<td><select id=PRODUCT tabindex='4' style='height:22px;font-size:12px;text-align:left;'>".$opt_product."</select></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;
					<b>PENERIMA &nbsp;&nbsp;
					:</b>&nbsp;&nbsp<td><input type=text tabindex='6' id=PENERIMA size=25 onkeypress='return charAndNumAndStrip(event);' maxlength=30 style='text-align:right;'></td>
					</tr>
...
echo"
     ...
     <tr><td align=center>
     <input type=button id=button1 tabindex='9' class=tombol2 value=GetWeight onclick=ambil_tanggal();>
     </td></tr>
     </table>
     </fieldset>
     </td>
     ...
     <input type=button id=SIMPAN class=tombol2 value=SIMPAN onclick=saveLain();>&nbsp;&nbsp;
...
CLOSE_BOX();
OPEN_BOX('');
echo "<center><b>LIST KENDARAAN TIMBANG LAIN-LAIN YG BELUM TIMBANG KELUAR</b></center>";
...
$str4="select *,count(TICKETNO) as tiket from ".$dbname.".mstrxtbs where PRODUCTCODE not in('40000001','40000002','40000003','40000004','40000005','40000005') and ".$dbname.".mstrxtbs.IDWB='".$IDWB."' group by TICKETNO having tiket=1";
//echo $str4;
...
while($bar4=mysql_fetch_object($res4)){
	...
	$str5="select * from ".$dbname.".msvendorbuyer where ".$dbname.".msvendorbuyer.BUYERCODE='".$bar4->TRPCODE."'";
  ...
  onclick=\"loadlain('".$bar4->TICKETNO."','".$bar4->VEHNOCODE."','".$bar4->TRPCODE."','".$bar4->DRIVER."','".tanggalnormal($bar4->DATEIN)."','".$bar4->WEI1ST."','".$bar4->PENERIMA."','".$bar5->BUYERNAME."','".$bar4->PRODUCTCODE."','".$bar6->PRODUCTNAME."','".$bar4->SPNO."');\">
 <td align=center>".$bar4->TICKETNO2."</td>
  ...
  <td align=center>".$bar5->BUYERNAME."</td>

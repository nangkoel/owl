...
$arrow_location="<img src='images/menu/arrow_4.gif'>";
$star=" ". $star." ";
					...
					if($bar_m2->class=='devider')
					  ...
					  echo"<li><span class=\"mtitle\" >".$bar_m2->caption."</span></li>";
				    else 
						{
							...
							{				
							 echo "<li><a class=\"induk\" href=\"javascript:void(0);\"> ".$star."".$bar_m2->caption."  ".$arrow_location."</a>";	
							     //===============================================
								 $str_m3="select * from ".$dbname.".menu
								         where parent=$master_m2
										  and hide=0 order by urut";			 	 
										...
										if($bar_m3->class=='devider')
										  ...
										  echo"<li><span class=\"mtitle\" >".$bar_m3->caption."</span></li>";
									    else 
											{
												...
												{
												echo "<li><a class=\"induk\" href=\"javascript:void(0);\"> ". $star."  ".$bar_m3->caption."  ".$arrow_location."</a>";	
												     //===============================================
													 $str_m4="select * from ".$dbname.".menu
													         where parent=$master_m3
															  and hide=0 order by urut";
														...
														while($bar_m4=mysql_fetch_object($res_m4))
														{
															...
															if($bar_m4->class=='devider')
															  ...
															  {							  	
																...
																{
																echo "<li><a class=\"induk\" href=\"javascript:void(0);\"> ". $star."  ".$bar_m4->caption."  ".$arrow_location."</a>";	
																     //===============================================
																	 $str_m5="select * from ".$dbname.".menu
																	         where parent=$master_m4
																			  and hide=0 order by urut";
																		...
																		while($bar_m5=mysql_fetch_object($res_m5))
																		{
																			...
																			if($bar_m5->class=='devider')
																		    ...
																		    else 
																			  {
																					...
																					{
																					echo "<li><a class=\"induk\" href=\"javascript:void(0);\"> ". $star."  ".$bar_m5->caption."  ".$arrow_location."</a>";	
																					     //===============================================
																						 $str_m6="select * from ".$dbname.".menu
																						         where parent=$master_m5
																								  and hide=0 order by urut";
																							...
																							while($bar_m6=mysql_fetch_object($res_m6))
																							{
																								...
																								if($bar_m6->class=='devider')
																							    ...
																							    else
																								  {
																									...
																									{
																									echo "<li><a class=\"induk\" href=\"javascript:void(0);\"> ". $star."  ".$bar_m6->caption."  ".$arrow_location."</a>";	
																									     //===============================================
																										 $str_m7="select * from ".$dbname.".menu
																										         where parent=$master_m6
																												  and hide=0 order by urut";
																										...
																										{	
																											...
																											while($bar_m7=mysql_fetch_object($res_m7))
																											{
																												...
																												if($bar_m7->class=='devider')
																												  ...
																												  echo "<li><a href=\"javascript:do_load('".$bar_m7->action."')\"> ". $star."  ".$bar_m7->caption."</a></li>"; 
																											}
																											echo"</ul>";									
																										}
																										 //===============================================
																									...
																									{
																									 echo "<li><a href=\"javascript:do_load('".$bar_m6->action."')\"> ". $star."  ".$bar_m6->caption."</a></li>";	
																									}
																								  } 
																							}
																							echo"</ul>";									
																					...
																					{
																					 echo "<li><a href=\"javascript:do_load('".$bar_m5->action."')\"> ". $star."  ".$bar_m5->caption."</a></li>";	
																					}																			  	
																			  }
																...
																{
																 echo "<li><a href=\"javascript:do_load('".$bar_m4->action."')\"> ". $star."  ".$bar_m4->caption."</a></li>";	
																}
												...
												{
												 echo "<li><a href=\"javascript:do_load('".$bar_m3->action."')\"> ". $star."  ".$bar_m3->caption."</a></li>";	
												}
							...
							{
							 echo "<li><a href=\"javascript:do_load('".$bar_m2->action."')\"> ". $star."  ".$bar_m2->caption."</a></li>";	
							}	
...
<td>
<div style=\"border-width:0px 0px 0px 1px;border-color:#aaaaaa;border-style:solid;font-size:1px;width:8px;height:31px;\">

</div>
<td style=\"padding:0px 5px 0px 0px;\">
     <input type=\"text\" style=\"font-family:arial;font-size:12px;width:100px;border-style:solid;border-width:1px;border-color:#ffffff;border-top-color:#aca899;border-left-color:#aca899;\" value=\"\">
</td>
<td style=\"padding:0px 5px 0px 0px;font-family:arial;font-size:10px;color:#444444\">SEARCH</td>
<td>

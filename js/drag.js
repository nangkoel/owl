...
// IE is retarded and doesn't pass the event object 
	...
	if ((e.button == 1 && window.event != null || e.button == 0) && (target.className == 'drag' || target.className == 'dragdyn')) 
	{ // grab the mouse position 
		_startX = e.clientX; 
		_startY = e.clientY; // grab the clicked element's position 
		...
		{ return false; }; // prevent IE from trying to drag an image 
...
//=============================================
//this is to prevent child win over the menu
	if(e.clientY<100)	
	   var Y=100;
	else
	   var Y= e.clientY;  

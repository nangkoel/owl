...
// ..FORM PILIH DATA
		echo "<fieldset style='float:left;'>
				...
				<table>
					...
					<tr>
						<td colspan=100>
						<button onclick=zPreview('keu_slave_2agingSPinjaman','".$arr."','printContainer') class=mybutton name=preview id=preview>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'keu_slave_2agingSPinjaman.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>

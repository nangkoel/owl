...
//    $namapt['']='undefined';
    ...
    while($res=mysql_fetch_assoc($query))
    {
        $luaspt[$res['kodeorganisasi']]+=$res['luas'];
    }       
    ...
    while($res=mysql_fetch_assoc($query))
    {
        $prodpt[$res['kodeorganisasi']]+=$res['kg'];
    }   
    ...
    while($res=mysql_fetch_assoc($query))
    {
        $prsdpt[$res['kodeorganisasi']]+=$res['kg'];
    }          
    //print_r($prsdpt);     
    // noakun 61
...
//		echo $str;
    ...
    while($res=mysql_fetch_assoc($query))
    {
        $bipt[$res['noakun']][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='711')$bipt7[711][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='712')$bipt7[712][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='713')$bipt7[713][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='714')$bipt7[714][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,5)=='71501')$bipt7[71501][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='716')$bipt7[716][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,5)=='71502')$bipt9[71502][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,5)=='71999')$bipt9[71999][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
    }
    ...
    while($res=mysql_fetch_assoc($query))
    {
        $sbipt[$res['noakun']][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='711')$sbipt7[711][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='712')$sbipt7[712][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='713')$sbipt7[713][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='714')$sbipt7[714][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,5)=='71501')$sbipt7[71501][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,3)=='716')$sbipt7[716][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,5)=='71502')$sbipt9[71502][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
        if(substr($res['noakun'],0,5)=='71999')$sbipt9[71999][$res['kodeorganisasi']]+=($res['debet']-$res['kredit']);
    }

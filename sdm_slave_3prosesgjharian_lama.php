        ...
        if($param['tipe']==3){
            ...
            */
            if ($_SESSION['empl']['regional']=='SULAWESI'){
                $query7="select sum(a.upah) as upah,a.idkaryawan as karyawanid,sum(a.premi) as premi,sum(a.penalty) as penalty,b.tipekaryawan,b.lokasitugas,b.subbagian  
                   from ".$dbname.".vhc_runhk_vw a left join 
                  ".$dbname.".datakaryawan b on a.idkaryawan=b.karyawanid
                ...
                $query7="select sum(a.upah) as upah,a.idkaryawan as karyawanid,sum(a.premi+a.premiluarjam) as premi,sum(a.penalty) as penalty,b.tipekaryawan,b.lokasitugas,b.subbagian  
                   from ".$dbname.".vhc_runhk_vw a left join 
                  ".$dbname.".datakaryawan b on a.idkaryawan=b.karyawanid
                   where b.tipekaryawan='".$param['tipe']."' and b.lokasitugas in (select kodeunit from 
                    ".$dbname.".bgt_regional_assignment where regional='".$_SESSION['empl']['regional']."') 

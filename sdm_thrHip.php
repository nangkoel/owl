...
echo"<fieldset style='float:left;'>
        <legend><b>Form</b></legend>
            <table border=0 cellpadding=1 cellspacing=1>
                ...
                <tr>
                    <td colspan=4>
                    <button onclick=zPreview('sdm_slave_thrHip','".$arr."','printContainer') class=mybutton name=preview id=preview>".$_SESSION['lang']['preview']."</button>
                    <button onclick=zExcel(event,'sdm_slave_thrHip.php','".$arr."') class=mybutton name=preview id=preview>".$_SESSION['lang']['excel']."</button>
                    </td>
                </tr>
            </table>
</fieldset>";
...
if ($_SESSION['empl']['regional']=='SULAWESI'){
    $note="<tr>
            <td colspan=3><br><b>* Khusus HIP, perhitungan THR hanya ada 2 pilihan agama: Islam dan Lainnya (Protestan,Katolik,Hindu,Budha,Konghucu)</b></td>
           </tr>";
}

 ...
 */
 ...
 function saveOrg()
 {
	...
	_orgalias    = trim(document.getElementById('orgalias').value);
	...
	_orgfax    = trim(document.getElementById('orgfax').value);
...
//++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 function clearForm()
 {
	...
	document.getElementById('orgalias').value ='';
	...
	document.getElementById('orgfax').value ='';
...
function getCurrent(code)
{
  ...
  function  fillForm(arrtex)
  {
	...
	document.getElementById('orgfax').value =arr[10];
	document.getElementById('orgalias').value =arr[11];
	curr=0;

...
?>
<script src='js/zTools.js'></script>
<?php
...
$optBrg = array('0'=>'Tidak Ada','1'=>'Ada');
...
$ctl[] = "<fieldset><legend><b>".$_SESSION['lang']['find']."</b></legend>".
	...
	makeElement('jurnal','label',$_SESSION['lang']['posting']).
    makeElement('jurnal','select','',array(),$optPost).
	
	makeElement('barang','label','Barang').
    makeElement('barang','select','',array(),$optBrg).
...
# Header
$header = array(
    $_SESSION['lang']['nomor'],$_SESSION['lang']['organisasi'],$_SESSION['lang']['tanggal'],
	$_SESSION['lang']['nikmandor'],$_SESSION['lang']['nikmandor1'],$_SESSION['lang']['asisten'],$_SESSION['lang']['keraniafdeling'],'updateby',$_SESSION['lang']['namakegiatan']
);

...
echo OPEN_BOX('','');
echo OPEN_THEME('Pengiriman Barang Selain CPO/PK (Excel)');
echo OPEN_BOX();
$stg="select * from ".$dbname.".msproduct where PRODUCTCODE not in('40000001','40000002','40000003','40000005') order by PRODUCTCODE";
//asli $stg="select * from ".$dbname.".msproduct where PRODUCTCODE = '40000006' or PRODUCTCODE='40000007' or PRODUCTCODE='40000005' order by PRODUCTCODE";
//echo $stg;
$reg=mysql_query($stg);
...
echo"<table>
	   ...
	   <tr><td>Tanggal </td><td>:&nbsp;<input type=text id=tgllap tabindex='1' class=myinputtext size=10 onmousemove=setCalendar(this.id) onkeypress=\"return false;\"></td></tr>
		...
		<table align=center> 
		 <tr><td><input type=button id=button1 tabindex='3' class=tombol2 value=GO onclick=PengirimanHarianPerTgl();></td></tr>
		 </table>

...
<script language=javascript1.2 src='js/log_5kendaliBarang.js'></script>
...
$iGudang="select kodeorganisasi,namaorganisasi from ".$dbname.".organisasi where tipe in ('GUDANG','GUDANGTEMP') "
        . " and SUBSTR(induk,1,4)='".$_SESSION['empl']['lokasitugas']."' order by namaorganisasi asc ";
...
echo"<fieldset style='float:left;'>";
    echo"<legend>".$_SESSION['lang']['stokkontrol']."</legend>";

...
$sListData="select distinct a.nopp,namabarang,a.kodebarang,satuan,a.hargasatuan,namasupplier,b.tanggal as tglpp,a.nopo,c.tgledit,a.tanggal,a.statuspo,c.tanggalkirim,
            c.idFranco,c.lokasipengiriman,c.purchaser,e.tglAlokasi ,a.jumlahpesan,a.matauang,c.kurs,e.satuanrealisasi 
...
else
{
 ...
 // echo $sListData;
	...
	<tr>
        ...
        <td ".$bgcoloraja." rowspan=2>".$_SESSION['lang']['satuan']." ".$_SESSION['lang']['realisasi']."</td>
...
while($rListData=mysql_fetch_assoc($qListData))
{
    ...
    $tanggalByr='';
                ...
                if ($proses=='excel'){
                    ...
                    $tab.="<td nowrap>".tanggalnormal($rListData['tglpp'])."</td>";
                    $tab.="<td>".$rListData['kodebarang']."</td>";
                    $tab.="<td>".$optNmBarang[$rListData['kodebarang']]."</td>";
                    $tab.="<td>".$optSatuan[$rListData['kodebarang']]."</td>";
                    $tab.="<td>".$rListData['nopo']."</td>";
                    $tab.="<td nowrap>".tanggalnormal($rListData['tanggal'])."</td>";
                    $tab.="<td>".$optNmOrang[$rListData['purchaser']]."</td>";
                    $tab.="<td nowrap>".tanggalnormal($rListData['tglAlokasi'])."</td>";
                    $tab.="<td align=right>".$jmlHari."</td>";
                    $tab.="<td align=right>".number_format($rRealisasi['realisasi'],0)."</td>";
                    $tab.="<td>".$rListData['satuanrealisasi']."</td>";
                    $tab.="<td align=right>".number_format($rListData['jumlahpesan'],0)."</td>";
                    ...
                    $tab.="<td align=right>".number_format($hargaBarang,0)."</td>";
                    $tab.="<td>".$rListData['namasupplier']."</td>";
                    $tab.="<td nowrap>".tanggalnormal($tglEdit)."</td>";
                }
                $tab.="<td>&nbsp;</td>";
                $tab.="<td>&nbsp;</td>";
                $tab.="<td>&nbsp;</td>";
                $tab.="<td>".$rTagihan['noinvoice']."</td>";
                $tab.="<td nowrap>".tanggalnormal($tanggalData)."</td>";
                $tab.="<td>".$tanggalByr."</td>";
                $tab.="<td>".$lokasi."</td>";
                $tab.="<td nowrap>".tanggalnormal($tglKirim)."</td>";
                $tab.="<td>&nbsp;</td>";
                $tab.="<td>&nbsp;</td>";
                $tab.="<td>&nbsp;</td>";
                $tab.="<td>".$rTransaksi['notransaksi']."</td>";
                $tab.="<td nowrap>".tanggalnormal($tglTerima)."</td>";
                $tab.="<td>&nbsp;</td>";
                $tab.="<td>&nbsp;</td>";
                $tab.="</tr>";
   }
...
{
    $tab.="<tr class=rowcontent><td colspan=32>".$_SESSION['lang']['dataempty']."</td></tr>";
}

...
$uname=$_POST['uname'];
 echo"<div>
     <fieldset style='width:200px;color:#333399;'>
      Map user<b> '".$uname."'</b> Privillages <img src=images/info.png height=30px style='vertical-align:middle;cursor:pointer;' title='Click for help..!'>
	 </fieldset><br>
	 ...
	 &nbsp &nbsp <a href=# onclick=\"resetDetailPrivillage('".$uname."')\" title='Clear All ".$uname." privillages'>Clear All</a>
	 <hr>
	 ";
echo"<ul>";
...
{
	$cx='';
	for($x=0;$x<count($_SESSION['priv']);$x++)
	{
	    if($_SESSION['priv'][$x]==$bar->id)
		    $cx='checked';
	}

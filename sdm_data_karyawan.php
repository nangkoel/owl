...
//lokasi tugas
//$optlokasitugas='';
$optlokasitugas="<option value=''></option>";
$optsubbagian="<option value=''></option>";
...
echo"<table>
     <tr valign=moiddle>
         ...
         <td><fieldset><legend>".$_SESSION['lang']['find']."</legend>"; 
                        echo $_SESSION['lang']['caripadanama'].":<input type=text id=txtsearch size=20 maxlength=30 onkeypress=\"return validatnama(event);\" class=myinputtext>";
						...
						echo $_SESSION['lang']['pt'].":<select id=schpt style='width:100px'>".$optPt."</select>";
                        ...
                        echo $_SESSION['lang']['nik'].":<input type=text id=niksch size=10 maxlength=10 onkeypress=\"return validatnik(event);\" class=myinputtext>";
...
$frm[0]="<fieldset><legend>".$_SESSION['lang']['inputdatakaryawan']."</legend>
         <table border=0 cellspacing=1>
                 <tr>
                    ...
                    <td align=right>".$_SESSION['lang']['employeename']."</td><td nowrap><input type=text class=myinputtext id=namakaryawan size=26 maxlength=40 onkeypress=\"return tanpa_kutip(event);\"><img src=images/obl.png title='Obligatory'></td>
                        <td align=right>".$_SESSION['lang']['tempatlahir']."</td><td nowrap><input type=text class=myinputtext id=tempatlahir size=26 maxlength=30 onkeypress=\"return tanpa_kutip(event);\"><img src=images/obl.png title='Obligatory'></td> 
                 </tr>
                 <tr>
                    <td align=right>".$_SESSION['lang']['tanggallahir']."</td><td nowrap><input type=text class=myinputtext id=tanggallahir size=26 onmousemove=setCalendar(this.id) maxlength=10 onkeypress=\"return false;\"><img src=images/obl.png title='Obligatory'></td>
                 ...
                 <tr>
                    <td align=right>".$_SESSION['lang']['lokasitugas']."</td><td><select onchange=getSub() id=lokasitugas style='width:150px;'>".$optlokasitugas."</select></td>
                 ...
                 <tr>
                    <td align=right>".$_SESSION['lang']['noktp']."</td><td nowrap><input type=text class=myinputtext id=noktp size=26 maxlength=30 onkeypress=\"return tanpa_kutip(event);\"><img src=images/obl.png title='Obligatory'></td>
                 ...
                 <tr>
				  <td align=right nowrap>".$_SESSION['lang']['lokasipenerimaan']."</td><td><input type=text class=myinputtext id=lokasipenerimaan size=26 maxlength=30 onkeypress=\"return tanpa_kutip(event);\"></td>
                 ...
                 <tr>
                    <td align=right valign=top rowspan=2>".$_SESSION['lang']['alamataktif']."</td><td rowspan=2 nowrap><textarea id=alamataktif cols=22 rows=3></textarea><img src=images/obl.png title='Obligatory'></td>
                    <td align=right>".$_SESSION['lang']['kota']."</td><td nowrap><input type=text class=myinputtext id=kota size=26 maxlength=30 onkeypress=\"return tanpa_kutip(event);\"><img src=images/obl.png title='Obligatory'></td>
                 ...
                 <tr>
                    ...
                    <td align=right>".$_SESSION['lang']['golongandarah']."</td><td><select id=golongandarah style='width:150px;'>".$optGoldar."</select></td>
                        <td align=right fontcolor=red>".$_SESSION['lang']['tanggalmasuk']."</td><td nowrap><input type=text class=myinputtext title='Harap berhati-hati karena Tanggal Masuk tidak dapat di-edit' id=tanggalmasuk size=26 maxlength=10 onkeypress=\"return false;\" onmousemove=setCalendar(this)><img src=images/obl.png title='Obligatory'></td> 
                 </tr>		 		 
                 <tr>
                    ...
                    <td align=right nowrap>".$_SESSION['lang']['statusperkawinan']."</td><td><select id=statusperkawinan style='width:150px;'>".$optstkawin."</select></td>
                    <td align=right nowrap>".$_SESSION['lang']['tanggalmenikah']."</td><td><input type=text class=myinputtext id=tanggalmenikah size=26 maxlength=10 onkeypress=\"return false;\" onmousemove=setCalendar(this)></td>
                 </tr>
                 <tr>
                    ...
                    <td align=right nowrap>".$_SESSION['lang']['jumlahtanggungan']."</td><td><input type=text class=myinputtext id=jumlahtanggungan size=26 maxlength=2  onkeypress=\"return angka_doang(event);\"></td>
                 ...
                 <tr>
                        <td align=right nowrap>".$_SESSION['lang']['levelpendidikan']."</td><td><select id=levelpendidikan style='width:150px;'>".$optlvlpendidikan."</select></td> 
                 ...
                 <tr>
                    ...
                    <td align=right>".$_SESSION['lang']['jms']."</td><td nowrap><input type=text class=myinputtext id=jms size=26 maxlength=30  onkeypress=\"return tanpa_kutip(event);\"><img src=images/obl.png title='Obligatory'></td>
				 ...
				 <tr>
                    ...
                    <td align=right>".$_SESSION['lang']['pangkat']."</td><td><input type=text class=myinputtext id=pangkat size=26 maxlength=45  onkeypress=\"return tanpa_kutip(event);\"></td>
                    
                    <td align=right nowrap>".$_SESSION['lang']['tanggalpengangkatan']."</td><td><input type=text ".$disabled."  class=myinputtext id=tanggalpengangkatan size=26 maxlength=10 onkeypress=\"return false;\" onmousemove=setCalendar(this)></td> 

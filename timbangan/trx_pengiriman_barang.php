...
$stg="select * from ".$dbname.".msproduct where PRODUCTCODE not in ('40000001','40000002','40000003') order by PRODUCTNAME";
$reg=mysql_query($stg);
...
$stg="select UNITCODE,UNITNAME from ".$dbname.".msunit where UNITCODE like '%M' or UNITCODE like 'C%' or UNITCODE LIKE 'M%' order by UNITCODE";
$reg=mysql_query($stg);
$opt_kirim="<option value='0'>Silakan Pilih...</option>";
	while($bag=mysql_fetch_array($reg))
		{
			$opt_kirim.="<option value='".$bag[0]."'>".$bag[1]."</option>";
		}
...
<strong><font size=3 color=#000000 font-family: Verdana, Arial, Helvetica, sans-serif>PENGIRIMAN BARANG SELAIN CPO/PK</font>
</strong></td>
...
echo"<!--<fieldset style='width:100%;text-align:right;'>-->
     ...
     <table border=0>
					...
					<tr><td><b>NO.SP &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					:</b></td>
					<td><input type=text tabindex='1' id=SPBNO size=25 onkeypress='return charAndNum(event);' maxlength=30  style='text-align:right;'>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<td><b>PENGANGKUT &nbsp;&nbsp;:</b></td>
					<td><select id=TRPCODE tabindex='4' style='height:22px;font-size:12px;text-align:left;'>".$opt_trp."</select></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;
					<b>SUPIR &nbsp;&nbsp;
					:</b>&nbsp;&nbsp<td><input type=text tabindex='7' id=DRIVER size=25 onkeypress='return charAndNum(event);' maxlength=30  style='text-align:right;'></td></tr>
					<tr><td><b>NO.KENDARAAN
					:</b></td>
					<td><input type=text id=VEHNOCODE tabindex='4' style='height:18px;text-align:left;font-size:12px;' size=8 maxlength=8 onkeypress=\"return tanpa_kutip(event);\">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<td><b>PENGIRIM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></td>
					<td><input type=text tabindex='5' id=PENGIRIM size=25 onkeypress='return charAndNum(event);' maxlength=30  style='text-align:right;'></td>
					</tr>
					<tr><td><b>BARANG &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					:</b></td>
					<td><select id=PRODUCT tabindex='3' style='height:22px;font-size:12px;text-align:left;'>".$opt_product."</select>
					</td>
					<td><b>PENERIMA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></td>
					<td><input type=text tabindex='6' id=PENERIMA size=25 onkeypress='return charAndNum(event);' maxlength=30  style='text-align:right;'></td>
...
echo"
	 ...
	 <tr><td>
		...
		BERAT  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type=text size=12 id=WEIGH1  style='height:20px;font-size:18px;text-align:right;'>&nbsp;<b>KG</B><br>
     </td></tr>
     <tr><td align=center>
     <input type=button id=button1 tabindex='8' class=tombol2 value=GetWeight onclick=ambil_tanggal();>
     </td></tr>
     </table>
     </fieldset>
     </td>
	 ...
	 <tr><td>
		...
		BERAT  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type=text size=12 id=WEIGH2  style='height:20px;font-size:18px;text-align:right;' disabled>&nbsp;<b>KG</B><br>
     </td></tr>
     <tr><td align=center>
     ...
     <input type=button id=SIMPAN class=tombol2 value=SIMPAN onclick=saveX();>&nbsp;&nbsp;
...
CLOSE_BOX();
OPEN_BOX('');
echo "<center><b>LIST KENDARAAN  YG BELUM TIMBANG KELUAR</b></center>";
 echo "<center><table border=1 cellspacing=0 width=70%></center>";
      echo "<tr>
			...
			<td align=center width=20%><b>PENGIRIM</b></td>
            <td align=center width=10%><b>SUPIR</b></td>
...
$str4="select *,count(TICKETNO) as tiket from ".$dbname.".mstrxtbs where  PRODUCTCODE not like '10%' and ".$dbname.".mstrxtbs.IDWB='".$IDWB."' and mstrxtbs.PENGIRIM is not null group by TICKETNO having tiket=1";
//echo $str4;
...
while($bar4=mysql_fetch_object($res4)){
  ...
  onclick=\"loadX('".$bar4->TICKETNO."','".$bar4->VEHNOCODE."','".$bar4->TRPCODE."','".$bar4->DRIVER."','".tanggalnormal($bar4->DATEIN)."','".$bar4->WEI1ST."','".$bar4->PENERIMA."','".$bar5->TRPNAME."','".$bar4->PRODUCTCODE."','".$bar6->PRODUCTNAME."','".$bar4->SPNO."','".$bar4->PENGIRIM."');\">
  <td align=center>".$bar4->TICKETNO2."</td>
  <td align=center>".$bar4->VEHNOCODE."</td>
  <td align=center>".tanggalnormal($bar4->DATEIN)."</td>
  <td align=center>".$bar6->PRODUCTNAME."</td>

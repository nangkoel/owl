...
echo"<div style='position:fixed;top:5px;right:35px'>".$_SESSION['standard']['username']." / ".$_SESSION['empl']['name']." / <b>".$_SESSION['empl']['lokasitugas']."</b> /<b> ".getNamaOrganisasi($_SESSION['empl']['lokasitugas'])."</b> </div>";
echo "

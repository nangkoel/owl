...
if($tk=='3')
{
    ...
    $stream.="<thead class=rowheader>
        <tr class=rowheader>
            ...
            <td bgcolor=#CCCCCC align=center>".$_SESSION['lang']['agama']."</td>
            ...
            <td bgcolor=#CCCCCC align=center>".$_SESSION['lang']['dasarthr']."</td>
       ...
       $iKar="select karyawanid,namakaryawan,nik,tipekaryawan,agama,kodejabatan,lokasitugas,subbagian,bagian,tanggalmasuk,tanggalpengangkatan"
               . " from ".$dbname.".datakaryawan where ".$wAgama." and tipekaryawan='".$tk."' and "
               . " lokasitugas='".$kdOrg."' and (tanggalkeluar='0000-00-00') order by agama,namakaryawan";
       ...
       foreach($kar as $karId)
       {
            ...
            $stream.="<tr class=rowcontent id=row".$no.">";
                ...
                $stream.="<td align=right>".number_format($masaKerja,2)."</td>";
                
                $stream.="<td align=right>".number_format($gaji[$karId],0)."</td>";
                $stream.="<td align=right>".number_format($gaji[$karId],0)."</td>";
                $stream.="<td align=right>".number_format($pengali,2)."</td>";
...
else 
{
    ...
    #bentuk karyawan harian
     $iKar="select karyawanid,namakaryawan,nik,tipekaryawan,agama,kodejabatan,lokasitugas,subbagian,bagian,tanggalmasuk,tanggalpengangkatan"
               . " from ".$dbname.".datakaryawan where ".$wAgama." and tipekaryawan='".$tk."' and "
               . " lokasitugas='".$kdOrg."' and (tanggalkeluar>'".$tglMulai."' or tanggalkeluar='0000-00-00') order by agama,namakaryawan";    
    ...
    $stream.="<thead class=rowheader>
        <tr class=rowheader>
            ...
            <td bgcolor=#CCCCCC rowspan=2 align=center>".$_SESSION['lang']['agama']."</td>
            ...
            <td bgcolor=#CCCCCC colspan=".$bulan." align=center>".$_SESSION['lang']['periode']."</td> 
            ...
            <td bgcolor=#CCCCCC rowspan=2 align=center>".$_SESSION['lang']['dasarthr']."</td> 
       ...
       foreach($kar as $karId)
       {
            ...
            $stream.="<tr class=rowcontent id=row".$no.">";
                ...
                $faktor=days_360($tgl,$tglMasuk[$karId])/360;
                if ($faktor>1) $faktor=1;
                if ($blnAktif)
                $a=$total[$karId]/$blnAktif;

                $dasarThr=round($a*$gaji[$karId],0);
                $upahThr=$dasarThr*$faktor;
                #bentuk pembulatan
                ...
                $stream.="<td align=right>".number_format($faktor,2)."</td>";
                $stream.="<td align=right>".number_format($dasarThr)."</td>";
...
######EXCEL	
	case 'excel':
		...
		$tglSkrg=date("Ymd");
		$nop_="Laporan_thr_".$pt."_".$kdOrg."_".$per;
		if(strlen($stream)>0)
		{

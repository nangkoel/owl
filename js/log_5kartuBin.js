...
function goCariBarang()
{
    ...
    tujuan = 'log_slave_5kartuBin.php';
...
function simpan()
{
    ...
    if(kdOrg=='' || kdBarang=='' || noKartu=='')
    {
            alert('Field Was Empty');
            return;
    }

    param='kdOrg='+kdOrg+'&kdBarang='+kdBarang+'&noKartu='+noKartu+'&method='+method;
    tujuan='log_slave_5kartuBin.php';
    post_response_text(tujuan, param, respog);		
...
function edit(kdOrg,kdBarang,noKartu)
{
    ...
    document.getElementById('noKartu').value=noKartu;
